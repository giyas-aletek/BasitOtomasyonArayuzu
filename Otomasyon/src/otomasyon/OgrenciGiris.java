...
public class OgrenciGiris extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("OGRENCI GIRIS SAYFASI");

        jLabel2.setText("Kullanci Adi");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       File f = new File(getClass().getClassLoader().getResource("veriTaban/OgrenciSifreler.TXT").getFile());
        try {
        ...
        if (bulundumu) {
            OgrenciSayfa o = new OgrenciSayfa();
